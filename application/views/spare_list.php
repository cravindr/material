...
require_once ('spares/spares_datatables_list.php');                 // modification file
...
require_once ('spares/spares_datatables_js.php');                   // modification file

require_once ('spares/spares_model_forms.php');                     // modification file
