...
require_once ('transaction/transaction_datatables_list.php');                 // modification file
...
require_once ('transaction/transaction_datatables_js.php');                   // modification file

require_once ('transaction/transaction_model_forms.php');                     // modification file
