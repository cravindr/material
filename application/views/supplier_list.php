...
require_once ('supplier/supplier_datatables_list.php');                 // modification file
...
require_once ('supplier/supplier_datatables_js.php');                   // modification file

require_once ('supplier/supplier_model_forms.php');                     // modification file
