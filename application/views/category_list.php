...
require_once ('category/catagory_datatables_list.php');             // modification file
...
require_once ('category/category_datatables_js.php');  /// modification file

require_once ('category/catagory_model_forms.php');    /// modification file
