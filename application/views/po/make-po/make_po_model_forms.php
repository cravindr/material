...
<!-- Modal -->
<div id="mkpo_supplier_select" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Purchase Order Supplier</h4>
            </div>
            <div class="modal-body">
				<form method="post" action="<?php echo site_url('porder/getsapareswithsupplierjson'); ?>">
					<div class="form-group">
						<label>Select Supplier</label>
						<select name="mkposupplier" id="mkposupplier" class="form-control">
						</select>
					</div>
					<div class="form-group">
